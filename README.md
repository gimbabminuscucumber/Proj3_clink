## 프로젝트 설명
- 채용을 원하는 기업과 취업을 원하는 지원자의 능률을 개선 시킨 취업 사이트 프로젝트입니다. 취업 준비생은 직무에 대한 정보를 쉽게 얻고 본인이 가진 직무 역량을 효과적으로 전달할 수 있으며, 채용담당자는 그런 지원자들의 특성을 회사와의 적정성과 매치해 인재상에 더 어울리는 지원자들을 발굴하고 관리할 수 있게 도와줍니다.
