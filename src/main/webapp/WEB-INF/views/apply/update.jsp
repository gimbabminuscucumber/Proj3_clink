...
<section>
	...
	<div class="central-meta">
		<h5 class="f-title"><i class="ti-info-alt"></i> 이력서 수정</h5>
		...
		<form action="${pageContext.request.contextPath }/apply/update" method="post" name="apply_write">
			...
			<div id="resume">
				...
				<div class="form-group">	
				  	<textarea rows="4" id="textarea" name="detail" required="required">${vo.DETAIL}</textarea>
				  	<label class="control-label" for="textarea">상세 내용</label><i class="mtrl-select"></i>
				</div>
			</div>
		</form>
		<div id="box">
			<input type="button" value="항목 추가" onclick="addForm()">
